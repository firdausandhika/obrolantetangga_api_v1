...
class User extends Authenticatable implements JWTSubject
{
     ...
     */
    protected $hidden = [
        'password', 'remember_token','otp','deleted_at','kategori_id','user_id','phone'
    ];
